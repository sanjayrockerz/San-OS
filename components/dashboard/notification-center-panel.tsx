...
export function NotificationCenterPanel({
  ...
  const triggerCoachReminders = async () => {
    try {
      await fetch("/api/cron/coach-reminders", { method: "POST" });
      if ("Notification" in window && Notification.permission === "granted") {
        new Notification("🤖 Intelligent Coach", {
          body: "Automated coach check complete! Check your daily focus priorities.",
          icon: "/logo.png",
        });
      }
    } catch {
