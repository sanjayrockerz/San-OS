...
export const EVENT_TYPES = {
  ...
  ProjectTaskCreated: "project.task_created",
  ProjectTaskCompleted: "project.task_completed",
  ProjectMilestoneCompleted: "project.milestone_completed",
  ProjectTimeLogged: "project.time_logged",
  ClientCreated: "client.created",
  ClientUpdated: "client.updated",
  ClientArchived: "client.archived",
  PipelineEntryCreated: "pipeline.created",
  PipelineStageChanged: "pipeline.stage_changed",
