...
VALUES
  ('30d10000-0000-0000-0000-000000000001','30d00000-0000-0000-0000-000000000001',NULL,'Week 1: Arrays, Strings & Hashing', true, 1, NULL),
  ('30d10000-0000-0000-0000-000000000002','30d00000-0000-0000-0000-000000000001',NULL,'Week 2: Linked Lists, Stacks & Queues', true, 2, '30d10000-0000-0000-0000-000000000001'),
  ('30d10000-0000-0000-0000-000000000003','30d00000-0000-0000-0000-000000000001',NULL,'Week 3: Trees & Binary Search', true, 3, '30d10000-0000-0000-0000-000000000002'),
  ('30d10000-0000-0000-0000-000000000004','30d00000-0000-0000-0000-000000000001',NULL,'Week 4: Graphs & DP', true, 4, '30d10000-0000-0000-0000-000000000003')
ON CONFLICT (id) DO NOTHING;

-- Week 1 Items
INSERT INTO roadmap_items (id, roadmap_id, parent_item_id, title, is_section, order_index)
VALUES
  ('30d20000-0000-0000-0000-000000000001','30d00000-0000-0000-0000-000000000001','30d10000-0000-0000-0000-000000000001','Two Sum', false, 1),
  ('30d20000-0000-0000-0000-000000000002','30d00000-0000-0000-0000-000000000001','30d10000-0000-0000-0000-000000000001','Valid Anagram', false, 2)
ON CONFLICT (id) DO NOTHING;
